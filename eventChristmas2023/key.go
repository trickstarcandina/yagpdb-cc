...
countevent -> đếm msg
checkfull -> check chat
eventdaily -> check daily
...
Hộp quà : 
Chúc mừng bạn mở quà được 20.000 owo ( 2/20 )
Chúc mừng bạn mở quà được 50.000owo ( 1/20 )
Hộp này hết quà rồi, tìm hộp khác nha ( 4/20 )
Bạn đã thu thập thêm được 2 quả thông ( 2/20 )
Bạn đã thu thập thêm được 1 quả thông ( 4/20 )
Chúc mừng bạn nhận được thêm 1 xí ngầu ( 4/20 )
Chúc mừng bạn nhận được Role Merry Christmas ! Cùng đón Giáng sinh thôi nào ! ( 3/20 )
